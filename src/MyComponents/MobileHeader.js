...
export default function MobileHeader({ toggleMobileHeaderClosebtn, closeMobileHeader, showMobileLanguageSelectOnClick, isScaled, MobileHeaderBtnHide }) {
    ...
    var offcanvasMobileHeader = document.getElementById('offcanvasMobileHeader');
    var categorySubMenu = document.getElementById('categorySubMenu');
    var offcanvasAllCategories = document.getElementById('offcanvasAllCategories');
    var offcanvasAllSubCategories = document.getElementById('offcanvasAllSubCategories');

    
    // var backdropCategorySubMenu = categorySubMenu.querySelector('.offcanvas-backdrop');
    // var backdropAllCategories = offcanvasAllCategories.querySelector('.offcanvas-backdrop');
    // var backdropAllSubCategories = offcanvasAllSubCategories.querySelector('.offcanvas-backdrop');
